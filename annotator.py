...
def select_image_folder():
    global images, image_index, previous_image_button, next_image_button, pupil_button, iris_button, current_img, canvas, delete_button, image_name_only, folder_path, points
    images = []
    image_index = 0
...
def callback(event):
    ...
    global current_img, points, points_index, delete_bool
    x = int(event.x)
    y = int(event.y)
